...
# Introduction
For a review of Seddik Hammads paper I check the expression of 210 genes in the 
1 year CCl4 chronic liver disease mouse model
...
# extract gene names
genes <- read_excel(here("data/seddik/210genes.xlsx")) |>
...
## How many of those 210 genes are covered?
```{r gene-coverage}
...
## Enrichment analysis
```{r enrichment, warning=FALSE, fig.height=8}
